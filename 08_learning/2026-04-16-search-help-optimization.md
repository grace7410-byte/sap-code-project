...
![i_structure_name](./image/sh_img1.png)

* **세팅**: 테이블 각 필드(자재마스터, 플랜트, 저장위치 등)에 FK를 걸어줌.
* **DATS 타입**: 자동으로 표준 달력이 띄워짐.

![dats_search_help](./image/sh_img2.png)
*DATS 타입 서치헬프 예시*
...
```
![Dropdown Result](./image/sh_img3.png)
*ALV 드롭다운 적용 화면*
...
```
![Dropdown Result](./image/sh_img4.png)
*ALV 드롭다운 적용 화면*
...
![Search Help Creation](./image/sh_img5.png)
*플랜트/저장위치 결합 서치헬프 생성 예시*

---

**관련 파일:**
* [./image/sh_img1.png](./image/sh_img1.png)
* [./image/sh_img2.png](./image/sh_img2.png)
* [./image/sh_img3.png](./image/sh_img3.png)
* [./image/sh_img4.png](./image/sh_img4.png)
* [./image/sh_img5.png](./image/sh_img5.png)
