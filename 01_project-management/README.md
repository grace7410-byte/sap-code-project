...
프로젝트 진행 과정에서 발생하는 기록을 관리하는 폴더입니다.
...
- **decisions**  
  프로젝트 진행 중 결정된 주요 사항 기록


---


## 📅 Development Phase Logs (04.04 ~ 04.18)

2주간의 설계 검토를 마치고 본격적인 ABAP/Fiori 개발 단계로 진입하였습니다.

### 🚀 Week 1: Development Kick-off (04.04 ~ 04.10)
...
### 🛠️ Week 2: Logic Implementation & Mentoring (04.11 ~ 04.18)
