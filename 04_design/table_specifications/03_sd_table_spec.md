...
| 번호 | 필드명 | KEY | Description | Data Element | Domain | Type | 길이 | Check Table | 비고 |
|:---:|:---|:---:|:---|:---|:---|:---:|:---:|:---|:---|
| 1 | MANDT | X | 클라이언트 | MANDT | MANDT | CLNT | 3 | T000 | |
...
| 번호 | 필드명 | KEY | Description | Data Element | Domain | Type | 길이 | Check Table | Search Help | Fixed Value | 비고 |
|:---:|:---|:---:|:---|:---|:---|:---:|:---:|:---|:---|:---|:---|
| 1 | MANDT | X | 클라이언트 | MANDT | MANDT | CLNT | 3 | T000 | | | |
| 2 | BPID | X | BP 코드 | ZEB1_SD_BPID | ZDB1_SD_BPID | CHAR | 10 | | KRED_C | | |
| 3 | BPTYP | X | BP 유형 | ZEB1_SD_BPTYP | ZDB1_SD_BPTYP | CHAR | 4 | | | 1,2,3,4 | 1: 공급업체 2: 고객 3: 세관 4: 운송업체 |
...
| 3 | MATNR | X | 자재 번호 | ZEB1_SD_MATNR | ZDB1_SD_MATNR | CHAR | 40 | ZTC2CNMM0001 | |
...
|:---:|:---|:---:|:---|:---|:---|:---:|:---:|:---|:---|
| 1 | MANDT | X | 클라이언트 | MANDT | MANDT | CLNT | 3 | T000 | |
| 2 | VBELN | X | 판매오더번호 | ZEB1_SD_VBELN | ZDB1_SD_VBELN | CHAR | 10 | 판매오더 아이템 | |
| 3 | POSNR | X | 아이템번호 | ZEB1_SD_POSNR | ZDB1_SD_POSNR | NUMC | 4 | 판매오더 아이템 | |
...
| 3 | VKORG | X | 영업조직 | ZEB1_SD_VKORG | ZDB1_SD_VKORG | CHAR | 4 | BP마스터(판매) | 1000: 국내 2000: 해외 |
| 4 | VTWEG | X | 유통경로 | ZEB1_SD_VTWEG | ZDB1_SD_VTWEG | CHAR | 2 | BP마스터(판매) | 10: 직판(주유소) 20:도매(기업거래), 30: 해외수출 |
| 5 | SOTYP | | 판매 오더 유형 | ZEB1_SD_SOTYP | ZDB1_SD_SOTYP | CHAR | 4 | | 판매 오더 유형 (OR 표준오더) |
| 6 | BPID | | 고객 코드 | ZEB1_SD_BPID | ZDB1_SD_BPID | CHAR | 10 | BP마스터(판매) | 고객 BP 아이디 |
...
| 10 | SOLDT | | 판매처 | ZEB1_SD_SOLDT | ZDB1_SD_SOLDT | CHAR | 10 | BP 마스터(일반) | |
| 11 | SHIPT | | 납품처 | ZEB1_SD_SHIPT | ZDB1_SD_SHIPT | CHAR | 10 | BP 마스터(일반) | |
...
| 16 | SOSTA | | 판매오더상태 | ZEB1_SD_SOSTA | ZDB1_SD_SOSTA | CHAR | 3 | | 오른쪽 표 참고 |
...
|:---:|:---|:---:|:---|:---|:---|:---:|:---:|:---|:---|
| 1 | MANDT | X | 클라이언트 | MANDT | MANDT | CLNT | 3 | T000 | |
| 2 | VBELN | X | 판매 문서 번호 | ZEB1_SD_VBELN | ZDB1_SD_VBELN | CHAR | 10 | 판매오더 헤더 | |
| 3 | POSNR | X | 판매 문서 항목 | ZEB1_SD_POSNR | ZDB1_SD_POSNR | NUMC | 4 | | |
| 4 | WERKS | | 플랜트 코드 | ZEB1_MM_WERKS | ZDB1_MM_WERKS | CHAR | 4 | ZTC2CNMM0000 | |
| 5 | LGORT | | 재고 저장위치 | ZEB1_MM_LGORT | ZDB1_MM_LGORT | CHAR | 4 | ZTC2CNMM0000 | |
| 6 | SPART | | 제품군 | ZEB1_SD_SPART | ZDB1_SD_SPART | CHAR | 2 | BP마스터(판매) | 10: 연료유, 20: 아스팔트 30: 석유화학 |
| 7 | MATNR | | 자재번호 | ZEB1_MM_MATNR | ZDB1_MM_MATNR | CHAR | 40 | ZTC2CNMM0001 | 자재번호 |
| 8 | KWMENG | | 주문 수량 | ZEB1_SD_KWMENG | ZDB1_SD_KWMENG | QUAN | 13,3 | | |
| 9 | NETPR | | 단가 | ZEB1_SD_NETPR | ZDB1_SD_NETPR | CURR | (15,2) | 가격 결정 | 가격결정T - PR00값(세전금액넣음) |
...
| 3 | VBELN_VA | | 판매 오더 번호 | ZEB1_SD_VBELN_VA | ZDB1_SD_VBELN_VA | CHAR | 10 | 판매오더 헤더 | |
| 4 | LFDAT | | 출고일 | ZEB1_SD_LFDAT | ZDB1_SD_LFDAT | DATS | 8 | | |
| 5 | SHIPT | | 납품처 | ZEB1_SD_SHIPT | ZDB1_SD_SHIPT | CHAR | 10 | BP 마스터(일반) | |
...
|:---:|:---|:---:|:---|:---|:---|:---:|:---:|:---|:---|
| 1 | MANDT | X | 클라이언트 | MANDT | MANDT | CLNT | 3 | T000 | |
| 2 | VBELN | X | 출고 문서 번호 | ZEB1_SD_VBELN | ZDB1_SD_VBELN | CHAR | 10 | 출고문서 헤더 | |
| 3 | POSNR | X | 항목 번호 | ZEB1_SD_POSNR | ZDB1_SD_POSNR | NUMC | 4 | | |
| 4 | VBELN_VA | | 참조 판매 문서 번호 | ZEB1_SD_VBELN_VA | ZDB1_SD_VBELN_VA | CHAR | 10 | 판매오더 아이템 | |
| 5 | POSNR_VA | | 참조 판매 항목 번호 | ZEB1_SD_POSNR_VA | ZDB1_SD_POSNR_VA | NUMC | 4 | 판매오더 아이템 | |
| 6 | WERKS | | 플랜트 코드 | ZEB1_MM_WERKS | ZDB1_MM_WERKS | CHAR | 4 | ZTC2CNMM0000 | |
| 7 | LGORT | | 재고 저장위치 | ZEB1_MM_LGORT | ZDB1_MM_LGORT | CHAR | 4 | ZTC2CNMM0000 | |
...
| 3 | VBELN_VA | | 출고 문서 번호 | ZEB1_SD_VBELN_VA | ZDB1_SD_VBELN_VA | CHAR | 10 | 출고문서 헤더 | |
...
| 15 | STATUS | | 대금 청구 상태 | ZEB1_SD_STATUS | ZDB1_SD_STATUS | CHAR | 1 | | 오른쪽 참고 |
| 16 | ERNAM | | 생성자 | ZEB1_ERNAM | ZDB1_ERNAM | CHAR | 12 | | |
| 17 | ERDAT | | 생성일 | ZEB1_ERDAT | ZDB1_ERDAT | DATS | 8 | | |
| 18 | ERZET | | 생성 시간 | ZEB1_ERZET | ZDB1_ERZET | TIMS | 6 | | |
| 19 | AENAM | | 변경자 | ZEB1_AENAM | ZDB1_AENAM | CHAR | 12 | | |
...
| 3 | MATNR | | 자재 코드 | ZEB1_SD_MATNR | ZDB1_SD_MATNR | CHAR | 40 | ZTB1MM0003 | |
