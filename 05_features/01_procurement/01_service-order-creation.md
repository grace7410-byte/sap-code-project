...
- **연동 흐름**: SES 확정 → 자재문서 생성([`ZTB1MM0011`](../../04_design/table_specifications/01_MM_table_spec.md#index11), [`ZTB1MM0012`](../../04_design/table_specifications/01_MM_table_spec.md#index12)) → FI 전표([`ZTB1FI0001`](../../04_design/table_specifications/04_FI_table_spec.md#index01), [`ZTB1FI0002`](../../04_design/table_specifications/04_FI_table_spec.md#index02)) 자동 인터페이스(매입/AP)
